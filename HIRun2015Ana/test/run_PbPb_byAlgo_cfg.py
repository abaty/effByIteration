...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('file:trk_WOPR.root')
)
...
#'file:/afs/cern.ch/user/a/abaty/work/private/CMSSW_WithQuadPix/CMSSW_9_0_0/src/RecoHI/HiTracking/config_tmp/step3.root'
#'file:/afs/cern.ch/user/a/abaty/work/private/CMSSW_WithQuadPix/CMSSW_9_0_0/src/RecoHI/HiTracking/config_tmp/step3_noGroupedCKF.root'
'file:step3_WOPR.root',
#'file:/afs/cern.ch/user/a/abaty/work/private/CMSSW_WithQuadPix/CMSSW_9_0_0/src/RecoHI/HiTracking/config_tmp/step3.root',
...
process.HITrackCorrectionsByAlgo.qualityString = cms.string("HighPurity")#currently turned off in C file
...
process.HITrackCorrectionsByAlgo.applyTrackCuts = True
...
#process.HITrackCorrectionsByAlgo.dzErrMax = 3.0
#process.HITrackCorrectionsByAlgo.ptErrMax = 0.1
#process.HITrackCorrectionsByAlgo.nhitsMin = 8
#process.HITrackCorrectionsByAlgo.chi2nMax = 300
#process.HITrackCorrectionsByAlgo.reso = 5
#process.HITrackCorrectionsByAlgo.crossSection = 1.0 #1.0 is no reweigh
#algo 
process.HITrackCorrectionsByAlgo.algoParameters = cms.vint32(4,23,22,24,7,5,8,9,10,11,37,38,39,40,41,42,43,44,45)#nominal result
#process.HITrackCorrectionsByAlgo.algoParameters = cms.vint32(4,23,22,24,7,5,8,6,10,11,37,38,39,40,41,42,43,44,45)#for studying pix pair
#process.HITrackCorrectionsByAlgo.algoParameters = cms.vint32(4,23,22,24,7,5,8,9,10,11,37,38,39,40,41,42,43,44,0)
